package net.yuziouo.MobSystem.Executor;
...
public class MeleeAttackCustomDamage implements IBehaviorExecutor {
    ...
    public MeleeAttackCustomDamage(Class<? extends EntityMemory<?>> memoryClazz, float speed, int maxSenseRange, boolean clearDataWhenLose, int coolDown,float damage) {
    ...
    public boolean execute(EntityIntelligent entity) {
        ...
        if (entity.distanceSquared(target) <= 4 && attackTick > coolDown) {
            ...
            float itemDamage = item.getAttackDamage()+damage ;
